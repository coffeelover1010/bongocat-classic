...
- `/bc` — show help.
- `/bc config` — toggle either cat, cycle compact T-shirt sizes (XS–XL), choose its fill, outline, UI layer, and lock/unlock the action cat's drag position.
