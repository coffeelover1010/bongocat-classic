...
- `/bc` — show help.
- `/bc config` — toggle either cat, cycle compact T-shirt sizes (XS–XL), choose Cream/White/Grey/None fill, choose its UI layer, and lock/unlock the action cat's drag position.
