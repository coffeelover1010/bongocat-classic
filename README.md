...
- `/bc` — show help.
- `/bc config` — toggle either cat, cycle compact T-shirt sizes (XS–XL), open native colour pickers for fill and outline, choose its UI layer, lock its drag position, and adjust inactivity fade settings.
